...
projects = {
  "<br><span class = 'project'>> Deploying a Highly Available Web Application on AWS using Terraform </span><br><span class = 'projectdes'>Deployed a highly available web application on AWS</span>":
    "https://github.com/Alien166/DevOps-Projects/tree/main/Deploying-a-Highly-Available-Web-Application-on-AWS-using-terraform",

  "<span class = 'project'>> Automated CI/CD Pipeline for Node.js Application </span><br><span class = 'projectdes'> Designed and implemented a CI/CD pipeline with Jenkins and Docker to automate </span>":
    "https://github.com/Alien166/DevOps-Projects/tree/main/Automated%20CI-CD%20Pipeline%20for%20Node.js%20with%20Jenkins%20and%20Docker",

  "<span class = 'project'>> Multi-Tier Application Deployment with Docker and Kubernetes </span><br><span class = 'projectdes'> Configured and deployed a multi-tier application using Docker and Kubernetes </span>":
    "https://github.com/Alien166/Multi-Tier-Application-Deployment-With-Docker-and-K8s",

  "<span class = 'project'>> DBMS Bash Script Project </span><br><span class = 'projectdes'>Developed a command-line-based Database Management System</span>":
    "https://github.com/Alien166/DevOps-Projects/tree/main/DBMS-Bash-Script-project",

};

links = {
  "<br>> Github": "https://github.com/Alien166",
  "> LinkedIn": "https://www.linkedin.com/in/abdeltawab-wagieh-825958226/"
};
...
function command_handler(command) {
  ...
  switch (command.toLowerCase()) {
    ...
    case "cat aboutme.txt":
      content.innerHTML += `<br>Hi, Well my name is Abdeltawab Wagieh Results-driven DevOps/SRE Engineer with expertise in debugging, coding, and leveraging tools like Docker,
      Kubernetes, Git, GitHub, Linux, CI/CD pipelines, and a variety of DevOps technologies. Certified as an IBM
      professional, Google Cloud Platform Associate Cloud Engineer (GCP ACE), AWS Certified Cloud Practitioner,
      and Oracle Cloud Infrastructure Certified. Possesses a strong foundation in software development
      methodologies and thrives in dynamic environments, ready to contribute effectively and continuously grow
      within a professional setting.. Good Bye ;)<br>`;
      break;
    case "fortune":
    ...
    case "contact":
      ...
      content.innerHTML +=
        "<br>Email: <a href='mailto:abdeltawab1.wagieh@gmail.com'>abdeltawab1.wagieh@gmail.com</a><br>";
      content.innerHTML +=
        "LinkedIn: <a href='https://www.linkedin.com/in/abdeltawab-wagieh-825958226/'>https://www.linkedin.com/in/abdeltawab-wagieh-825958226/</a><br>";
      break;

    case "cat resume.pdf":
      window.open(
        "https://drive.google.com/file/d/1o8MFdnDquJqY-tB6wJ8mLubbcF-lyoDV/view?usp=sharing"
      );
    case "cat standardportfolio.html":
      window.open(
        "https://github.com/Alien166"
      );
      // content.innerHTML +=
    ...
    case "github":
      const githubUsername = "Alien166"; // Replace with your GitHub username
    ...
    case "linkedin":
      window.open("https://www.linkedin.com/in/abdeltawab-wagieh-825958226/");
      break;
    ...
    case "cat languages.txt": // List your programming languages
      ...
      content.innerHTML +=
        ...
        "- Infrastructure as Code (IaC) with Terraform, Ansible<br>" +
        "- Scripting (Python, Bash)<br>" +
        "- Security Automation<br>" +
        "- Monitoring and Logging (Prometheus, Grafana, ELK Stack)<br>" +
        "- Vulnerability Scanning and Penetration Testing<br>" +
        "- Version Control (Git)<br>" +
        "- Compliance and Security Frameworks (OWASP, SOC2, NIST)<br>";
      break;
    ...
    case "cat workexperience.txt":
        content.innerHTML +=
          "<br><span class='work-heading'><b>DevOps Engineer Intern - Nokia</b></span><br>" +
          "08/2024 – 09/2024<br>" +
          "- Contributed to building and optimizing CI/CD pipelines, automating infrastructure tasks, and setting up monitoring and logging systems.<br>" +
          "- Focused on improving software delivery, deployment processes, and application reliability in a telecom environment.<br>" +
          "Cairo, Egypt<br>" +
  
          "<br><span class='work-heading'><b>Global Student Experience Intern - Schneider Electric</b></span><br>" +
          "07/2024 – 09/2024<br>" +
          "- Contributed to various projects enhancing digital solutions and sustainability, collaborating with teams to analyze data, support digital transformation, and drive innovation.<br>" +
          "Cairo, Egypt<br>" +
  
          "<br><span class='work-heading'><b>DevOps Engineer Intern - Exlearn Technologies</b></span><br>" +
          "03/2024 – 06/2024<br>" +
          "- Collaborated with teams to automate software delivery, implement CI/CD pipelines using Jenkins and GitHub Actions, manage infrastructure with Terraform, and monitor application performance for reliability.<br>" +
          "Cairo, Egypt<br>" +
  
          "<br><span class='work-heading'><b>Artificial Intelligence Engineer Intern - Orange Egypt</b></span><br>" +
          "04/2024 – 06/2024<br>" +
          "- Assisted in the development and deployment of AI-driven solutions, applying machine learning techniques to real-world challenges.<br>" +
          "- Collaborated with cross-functional teams to enhance AI models.<br>" +
          "Cairo, Egypt<br>" +
  
          "<br><span class='work-heading'><b>Artificial Intelligence Engineer Intern - Samsung Electronics</b></span><br>" +
          "- Worked on AI-driven projects, applying machine learning techniques to enhance products and services.<br>" +
          "- Collaborated with cross-functional teams to develop AI models.<br>";
        break;
...
if (userConfirmed) {
    window.open("https://www.github.com/Alien166")
} else {
